...
# Absolute path to the instance folder and database
basedir = os.path.abspath("C:/Users/Siris/Desktop/GitHub Projects 100 Days NewB/_24_0071_Day67_RESTful_Blog_with_Editing__240717/NewProject/r20-r29/r23_env_NWY/instance")
database_path = os.path.join(basedir, "posts.db")
...
def fetch_posts():
    ...
    db_posts = BlogPost.query.order_by(BlogPost.date.desc()).all()
    db_posts_list = []
